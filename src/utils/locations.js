...
export const getAddressForCoordinates = async (coordinate) => {
    return await fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${coordinate.latitude},${coordinate.longitude}&key=${process.env.GOOGLE_MAPS_API_KEY}`)
}